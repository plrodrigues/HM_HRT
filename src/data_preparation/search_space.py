...
def get_all_times_in_different_columns_per_task(
    ...
    df_predecessors = prepare_predecessor_as_list_per_sucessor(ins_x.df_predecessor_sucessor)

    df_times_w_list_predecessors = merge_times_with_list_predecessors(df_times, df_predecessors)
